  ...
  return (
    <div style={{ position: 'relative', height: '82vh', width: '100%' }}>
      <MapContainer center={position} zoom={13} style={{ height: '100%', width: '100%' }}>
        ...
        <DrawingModeControl drawingMode={drawingMode} setDrawingMode={setDrawingMode} />
        ...
        <ForbiddenZonesInitializer />
        {drawingMode === 'path' ? <MapClick /> : <ForbiddenZoneDrawing />}
      </MapContainer>
      ...
      <div style={{
        ...
        <button
          onClick={() => setFlightPathMenuOpen(!flightPathMenuOpen)}
          style={{
            background: '#FFD700',
            padding: '10px 16px',
            borderRadius: '12px',
            ...
            <div style={{ padding: '12px 16px' }}>
              <div style={{
                ...
                <input
                  ...
                  onChange={() => setConfirmFlightPath(!confirmFlightPath)}
